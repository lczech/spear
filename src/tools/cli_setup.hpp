#ifndef SPEAR_TOOLS_CLI_SETUP_H_
#define SPEAR_TOOLS_CLI_SETUP_H_
...
/**
 * @brief Callback wrapper function to use for spear commands.
 *
 ...
 */
std::function<void()> spear_cli_callback(
...
/**
 * @brief Check recursively that all spear subcommands have unique names, across modules.
 *
...
/**
 * @brief Check recursively that all spear subcommands and options have names and descriptions set.
 */
 ...
 * See spear_cli_callback() for details.
 */
