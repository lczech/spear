...
{
    #pragma omp critical(SPEAR_FILE_INPUT_PATHS)
    {
...
void FileInputOptions::print() const
{
    ...
    LOG_MSG1 << "Found " << files.size() << type << " file"
             << ( files.size() != 1 ? "s" : "" );
    // LOG_MSG2 << genesis::util::join( base_file_names(), ", " );
    ...
    //             std::cout << ", ";
    //         }
    //         std::cout << genesis::util::file_basename( file );
    //     }
    //     std::cout << "\n";
    // } else {
    //     std::cout << "Found " << files.size() << type << " file";
    ...
    //         std::string rp;
    //         try{
    //             rp = genesis::util::real_path( file );
    //         } catch(...) {
    //             rp = file;
    //         }
    //         std::cout << "  - " << rp << "\n";
