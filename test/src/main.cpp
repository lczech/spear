...
/**
 * @brief Main function for testing spear using Gtest.
 *
 * @file
 * @ingroup test
 */
...
SpearTestEnvironment* environment;

void spear_test_sighandler( int signum )
{
...
int main(int argc, char **argv)
{
    ...
    environment = new SpearTestEnvironment();
    ...
    // signal( SIGSEGV, spear_test_sighandler );
