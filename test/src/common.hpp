#ifndef SPEAR_TEST_COMMON_H_
#define SPEAR_TEST_COMMON_H_
...
/**
 * @Brief Environment class for testing spear.
 */
class SpearTestEnvironment : public ::testing::Environment {
public:
...
/**
 * @brief Instance of the SpearTestEnvironment, which is set in `main()`.
 */
extern SpearTestEnvironment* environment;
